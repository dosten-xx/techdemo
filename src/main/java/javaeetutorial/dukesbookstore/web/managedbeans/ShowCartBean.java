...
/**
 * Backing bean for the <code>/bookshowcart.xhtml</code> page.
 */
@Named("showcart")
@SessionScoped
public class ShowCartBean extends AbstractBean
{
   ...
   /**
    * Report the change to the shopping cart, based on the values entered in
    * the "Quantity" column.
    * 
    * @return null string
    */
   public String update()
   {
      ...
      FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("changed", "false");
      return (null);
   }
}
